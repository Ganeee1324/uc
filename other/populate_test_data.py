...
def populate_database():
    ...
    vetrine_data = [
        ...
        # Multi-file vetrine (3+ files)
        {
            ...
            "files": [
                ("python_basics.pdf", "# Python Basics\n\n## Variables and Types\nPython is a dynamically typed language...", 5, "dispense"),
                ("python_advanced.pdf", "# Advanced Python\n\n## Decorators\nDecorators are a powerful way to modify functions...", 5, "dispense"),
                ("python_exercises.pdf", "# Python Exercises\n\n1. Write a function to calculate Fibonacci numbers...", 3, "esercizi"),
                ("python_solutions.pdf", "# Exercise Solutions\n\ndef fibonacci(n):\n    if n <= 1: return n\n    return fibonacci(n-1) + fibonacci(n-2)", 2, "esercizi")
            ]
        },
        {
    ...
    for i, vetrina_info in enumerate(vetrine_data):
        ...
        for filename, content, price, tag in vetrina_info['files']:
            print(f"  Adding file: {filename} (Tag: {tag})")
